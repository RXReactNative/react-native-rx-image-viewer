...
const IsIPhoneX = Platform.OS === "ios" && (window.height === 812 && window.width === 375 || window.height === 375 && window.width === 812 || window.height === 414 && window.width === 896 || window.height === 896 && window.width === 414);
...
export default ((width = 0, height = 0, backgroundColor = 'white') => {
  return {
