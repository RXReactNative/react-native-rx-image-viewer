...
import { StyleSheet, View, Animated, PanResponder, LayoutChangeEvent, UIManager, findNodeHandle } from 'react-native';
...
export default class RXZoom extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.centerOn && !this.props.centerOn || nextProps.centerOn && this.props.centerOn && this.didCenterOnChange(this.props.centerOn, nextProps.centerOn)) {
  ...
  didCenterOnChange(params = { x: 0, y: 0, scale: 0, duration: 0 }, paramsNext = { x: 0, y: 0, scale: 0, duration: 0 }) {
  ...
  render() {
    ...
    return React.createElement(
      View,
      _extends({
        style: _extends({}, lastStyles.container, parentStyles, {
      ...
      React.createElement(
        Animated.View,
        { style: animateConf, renderToHardwareTextureAndroid: true },
        React.createElement(
          View,
          {
            ref: e => {
...
RXZoom.defaultProps = _extends({}, ZoomPropsType);
RXZoom.defaultProps = _extends({}, ZoomDefaultProps);
